  ...
  <div id="recru_div">
    <div id="select_div">
      <div class="retype_div">
        ...
        <el-button type="primary" style="float: right;margin-right: 10px;" @click="drawer= true">新增需求</el-button>
      </div>
      <!-- 新增需求弹框-->
      <el-drawer
        :visible.sync="drawer"
    ...
    <div id="main_div">
      ...
      <div class="boxs-card" v-for="(v,k) in recru">
        <div @click="recru_detail(v)" style="overflow: hidden;display: block;">
          ...
          <div class="times tops"
           style="font-weight: bold;
          width: 1px;
          height: 15px;
          line-height: 15px;
          border-right: 2px solid orange;"></div>
          <div class="fonts tops fonts" style="margin-left: 33.5%;">
            期望日期：<a>{{v.hopetime}}</a>
          </div>
          <div class="rec1 tops" style="color: darkgray;">
            需求人数：<a style="color: orange;font-size: 14px;">{{v.peopcout}}</a>
          </div>
          <div class="rec1 tops" style="color: darkgray;">
            招聘需求：<a style="color: orange;font-size: 14px;">{{v.recrudemand}}</a>
          </div>
        </div>
      </div>
    </div>
